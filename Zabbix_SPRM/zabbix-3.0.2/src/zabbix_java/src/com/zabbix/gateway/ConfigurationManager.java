...
class ConfigurationManager
{
	...
	// Add by H.Tan 2016/06/16
	public static final String WILD_FLYS = "wildFlys"; 
	...
	private static ConfigurationParameter[] parameters =
	{
		...
		new ConfigurationParameter(TIMEOUT, ConfigurationParameter.TYPE_INTEGER, 3,
				...
				null),
		// Add by H.Tan 2016/06/16
		new ConfigurationParameter(WILD_FLYS, ConfigurationParameter.TYPE_INETADDRESS_LIST, new ArrayList<InetAddress>(),
				null,
				null)
	};
